...
export const whatsNewItems: any[] = [
  ...
  },
  {
    ...
    type: "project",
    description:
      "Synaptic-Web is a real-time 3D visualization system that simulates the growth and evolution of interconnected nodes in a self-organizing network. It's built using egui and Rust",
  },
]
...
export const projects = [
  {
    ...
    achievements: [
      "implementation of algotithms for searching for a particular node in the eco-system",
      "addition of new nodes at an interval, with additional factors into play like health factor, half life, etc",
      "understanding of different data structures in detail, and implementation of a GUI using Rust",
    ],
